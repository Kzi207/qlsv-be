...
const parseCoordinatesFromText = (input: unknown): { lat: number; lng: number } | null => {
...
const isAllowedGoogleMapsUrl = (value: string): boolean => {
  try {
...
export const resolveMapCoordinates = async (req: AuthRequest, res: Response) => {
